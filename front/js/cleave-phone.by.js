...
*/
    ...
    function C(n, t) {
        ...
        switch (n.u.b.length) {
            ...
            case 3:
                ...
                n.A = !0;
            default:
                return n.A ? (P(n) && (n.A = !1), n.b.toString() + n.a.toString()) : 0 < n.f.length ? (e = q(n, t), r = D(n), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? Y(n, e) : n.i.toString())) : M(n)
        }
    }
    ...
    var U = 1, k = 2, J = 3, K = 4, L = 6, O = 16, Z = 18;
...
*/
    ...
    }, n("Cleave.AsYouTypeFormatter", B), n("Cleave.AsYouTypeFormatter.prototype.inputDigit", B.prototype.L), n("Cleave.AsYouTypeFormatter.prototype.clear", B.prototype.K)
